...
function Human(object){
    if(object.isCool === undefined){
     this.isCool = true;
    } else {
     this.isCool = object.isCool;
    }
    this.feed = function(myPet){
     myPet.isHungry = false;
    },
    this.pet = function (myPet){
     this.mood = "happy";
     myPet.mood = "happy";
    }
}

function Pet(myObject){
   this.color = myObject.color,
   this.isHungry = myObject.isHungry
